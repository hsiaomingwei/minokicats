...
function Home() {
  return (
    <div style={{ background: '#000', scrollBehavior: 'smooth' }}>      <a href='/shop' style={{ position: 'fixed', top: '40px', right: '40px', color: '#fff', textDecoration: 'none', zIndex: 10, fontSize: '14px', letterSpacing: '1px' }}>SHOP</a>
      <a href='/shop' style={{ position: 'fixed', top: '40px', right: '40px', color: '#fff', textDecoration: 'none', zIndex: 10, fontSize: '14px', letterSpacing: '1px' }}>SHOP</a>
